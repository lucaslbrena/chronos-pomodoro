        ...
        {cycleSteps.map((_, index) => {
          ...
          return (
            <span
              ...
              aria-label={`indicador de ciclo de ${cycleDesscriptionMap[nextCycleType]}`}
              title={`indicador de ciclo de ${cycleDesscriptionMap[nextCycleType]} `}
            ></span>
          );
        })}
